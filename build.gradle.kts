...
// managed-integrity-v1: czJisWM9egv
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-web-common", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-web-common")
        description.set("Shared Kotlin Multiplatform HTTP client utilities for retries, timeouts, etiquette headers, and diagnostic body sampling.")
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-web-common"
